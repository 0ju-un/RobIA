...
from timm.models.efficientnet_builder import _parse_ksize, _scale_stage_depth
...
class EfficientNetBuilder:
    ...
    def _make_block(self, ba, block_idx, block_count):
        ...
        elif bt == 'ir-attex-moe':
            from .efficientnet_moe import InvertedResidualMoE
            _log_info_if('  InvertedResidualMoE {}, Args: {}'.format(block_idx, str(ba)), self.verbose)
            block = InvertedResidualMoE(**ba)
        else:
